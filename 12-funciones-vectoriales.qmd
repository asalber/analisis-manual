...
:::{.callout-warning}
No debe confundirse el vector velocidad $\mathbf{v}=f'(t)$ con la rapidez del móvil dada por $|\mathbf{v}|$.
:::
...
:::{.content-visible when-format="html"}
![Aceleración de una trayectoria circular en el plano.](img/funciones-vectoriales/aceleracion-trayectoria-circular.png)
:::
