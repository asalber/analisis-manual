...
Las representaciones gráficas de las funciones vectoriales se conocen como _trayectorias_ o _curvas_. Así, la gráfica de una función vectorial en $\mathbb{R}^2$ es una trayectoria en el plano real.
...
Las función vectorial $\mathbf{f}(\operatorname{sen}(t),\cos(t)$ describe la misma trayectoria en el intervalo $t\in[0,2\pi]$, que la función $\mathbf{g}(x) = (\operatorname{sen}(2x), \cos(2x))$ en el intervalo $x\in[0,\pi]$. Se puede pasar de la primera parametrización a la segunda mediante el cambio de variable $t=2x$, y de la segunda a la primera mediante el cambio de variable $x=t/2$.

:::{.content-visible when-format="html"}
![Parametrización de una trayectoria circular.](img/funciones-vectoriales/parametrizacion-trayectoria-circular.png)
:::

:::{.content-visible unless-format="html"}
![Parametrización de una trayectoria circular.](img/funciones-vectoriales/parametrizacion-trayectoria-circular.pdf)
:::


:::{.content-visible when-format="html"}
![Otra parametrización de la trayectoria circular.](img/funciones-vectoriales/parametrizacion-trayectoria-circular-2.png)
:::

:::{.content-visible unless-format="html"}
![Otra parametrización de la trayectoria circular.](img/funciones-vectoriales/parametrizacion-trayectoria-circular-2.pdf)
:::
:::
...
## Demostración
:::{.proof}
Sea $\mathbf{f}(t) = (f_1(t),\ldots,f_n(t))$. Aplicando el @thm-derivada-funciones-vectoriales se tiene
...
:::{.content-visible when-format="html"}
![Parametrización de una trayectoria recta.](img/funciones-vectoriales/parametrizacion-longitud-arco-1.png)
:::

:::{.content-visible unless-format="html"}
![Parametrización de una trayectoria recta.](img/funciones-vectoriales/parametrizacion-longitud-arco-1.pdf)
:::
...
Si $\mathbf{f}(s)$ es una función vectorial parametrizada con la longitud de arco de curva, entonces $\mathbf{f}'(s)$ es un vector unitario.
:::

:::{.callout-note collapse="true"}
## Demostración
:::{.proof}
Sea $s$ el parámetro dado por la función arco de la trayectoria de la función vectorial $\mathbf{f}(t)$ para $t\in[a,b]$, es decir,
...
Por otro lado, al realizar el cambio de variable para la parametrizar la función vectorial mediante la longitud de arco, al aplicar la regla de la cadena se tiene
