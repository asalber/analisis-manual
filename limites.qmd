...
Se dice que el límite de la función $f:\mathbb{R}\rightarrow \mathbb{R}$ cuando $x\rightarrow a$ es $l$, y se escribe

$$\lim_{x\rightarrow a} f(x) = l$$ 

si para cualquier número $\varepsilon>0$ existe un número $\delta>0$ tal que, $|f(x)-l|<\varepsilon$  $\forall |x-a|<\delta$.
:::
...
Se dice que el límite de la función $f:\mathbb{R}\rightarrow \mathbb{R}$ cuando $x\rightarrow +\infty$ es $l$, y se escribe
...
Dadas dos funciones $f,g:\mathbb{R}\rightarrow \mathbb{R}$, tales que existe $\lim_{x\rightarrow a}f(x)$ y $\lim_{x\rightarrow a}g(x)$, entonces se cumple que
...
4. $\lim_{x\rightarrow a}\dfrac{f(x)}{g(x)}=\frac{\displaystyle \lim_{x\rightarrow a}f(x)}{\displaystyle \lim_{x\rightarrow a}g(x)}$ si $\lim_{x\rightarrow a}g(x)\neq 0.$
:::
