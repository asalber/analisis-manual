...
## Valores intermedios
Dado un intervalo cerrado y acotado $I=[a,b]$, y una función $f:I\to\mathbb{R}$, si $f$ es continua en $I$ y si $c,d\in I$, entonces para cualquier $k\\mathbb{R}$ con $f(c)<k<f(d)$, existe $e\in I$ entre $c$ y $d$ tal que $f(e)=k$.
:::
...
## Demostración
:::{.proof}
Por el @thm-extremos-funcion-continua-intervalo-cerrado existe $c,d\in I$ tales que $f(c)\leq f(x)\leq f(d)$ $\forall x\in I$.
...
## Demostración
:::{.proof}
Por el @thm-extremos-funcion-continua-intervalo-cerrado existe $c,d\in I$ tales que $f(c)\leq f(x)\leq f(d)$ $\forall x\in I$, por lo que $f(I)\subseteq[f(c), f(d)]$.
