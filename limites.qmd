...
Se dice que el límite de la función $f:\mathbb{R}\$ cuando $x\rightarrow a$ es $l$, y se escribe
...
:::{#def-}
## Infinitésimos equivalentes**. Si $f(x)\rightarrow 0$ y $g(x)\rightarrow 0$ cuando $x\rightarrow a$, entonces se dice que $f$ y $g$ son *infinitésimos equivalentes* cuando $x\rightarrow a$ si se cumple
...
:::{#def-}
## Asíntota vertical**. Se dice que una recta $x=a$ es una *asíntota vertical* de una función $f$ si se cumple
...
:::{#def-}
## Asíntota horizontal**. Se dice que una recta $y=a$ es una *asíntota horizontal* de una función $f$ si se cumple
...
:::{#def-}
## Asíntota oblicua**. Se dice que una recta $y=a+bx$ es una *asíntota oblicua* de una función $f$ si se cumple
...
:::{#def-}
## Función continua en un punto**. Se dice que una función $f$ es *continua* en el punto $a$ si
...
:::{#def-}
## Función continua en un intervalo**. Se dice que una función $f$ es *continua* en un intervalo si lo es en cada uno de los puntos del intervalo.
:::
...
:::{#def-}
## Discontinuidad de 1ª especie de salto finito**. Se dice que una función $f$ tiene una *discontinuidad de 1ª especie de salto finito* en el punto $a$ si existen los límites laterales de $f(x)$ cuando $x\rightarrow a$ pero
...
:::{#def-}
## Discontinuidad de 1ª especie de salto infinito**. Se dice que una función $f$ tiene una *discontinuidad de 1ª especie de salto infinito* en el punto $a$ si
...
:::{#def-}
## Discontinuidad de 2ª especie**. Se dice que una función $f$ tiene una *discontinuidad de 2ª especie* en el punto $a$ si no existe alguno de los límites laterales y tampoco se trata de una discontinuidad de 1ª especie de salto infinito.
:::
