...
## Demostración
:::{.proof}
Como $g$ es continua en $f(a)$, para cualquier $\varepsilon>0$ existe $\delta'>0$ tal que si $|x-f(a)|<\delta'$ entonces $|g(x)-g(f(a))|<\varepsilon$. 

Por otro lado, como $f$ es continua en $a$, para $\delta'>0$ existe otro $\delta>0$ tal que si $|x-a|<\delta$, entonces $|f(x)-f(a)|<\delta'$. 

Así pues, si $|x-a|<\delta$ se tiene que $|f(x)-f(a)|<\delta'$ y $|g(f(x))-g(f(a))|<\varepsilon$, por lo que $\lim_{x\to a}g(f(x)) = g(f(a))$ y $g\circ f$ es continua en $a$.
:::
:::
