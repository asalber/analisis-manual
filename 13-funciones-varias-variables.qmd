---
title: Análisis de funciones de varias variables
crossref:
    chapters: true
execute: 
  echo: false
...
En este capítulo analizaremos este tipo de funciones, en particular funciones de $\mathbb{R}^2$ en $\mathbb{R}$ y de $\mathbb{R}^3$ en $\mathbb{R}$, aunque los resultados se pueden generalizar fácilmente para funciones de $\mathbb{R}^n$ en $\mathbb{R}$.
