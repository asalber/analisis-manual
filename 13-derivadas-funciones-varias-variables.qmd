...
::: {.content-visible when-format="html"}
![Gráfica y curvas de nivel de la función $f(x,y) = y^2-x^2$.](./img/derivadas-funciones-varias-variables/curvas-nivel.svg)
:::

:::{.content-visible unless-format="html"}
![Gráfica y curvas de nivel de la función $f(x,y) = y^2-x^2$.](./img/derivadas-funciones-varias-variables/curvas-nivel.pdf)
:::
...
::: {.content-visible when-format="html"}
![Función de dos variables sin límite en $(0,0)$.](./img/derivadas-funciones-varias-variables/no-existencia-limite.svg){#fig-no-existencia-limite-2}
:::
...
## Multiplicadores de Lagrange
Dada una función de $n$ variables $f(x_1,\ldots,x_n)$, los extremos relativos de $f$ sujetos a la restricción $g(x_1,\ldots,x_n)=0$, son los puntos que cumplen las ecuaciones
