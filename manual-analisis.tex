...
\Huge
{\Ubuntu \textbf{Manual de Análisis Matemático Real}}

\vspace{0.5cm}
\LARGE
{\Ubuntu \textbf{para Ciencias e Ingenierías}}
...
\end{tabular}
\end{flushleft}
\end{titlepage}\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[borderline west={3pt}{0pt}{shadecolor}, frame hidden, sharp corners, interior hidden, boxrule=0pt, enhanced, breakable]}{\end{tcolorbox}}\fi
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomrule=.15mm, bottomtitle=1mm, leftrule=.75mm, colframe=quarto-callout-note-color-frame, coltitle=black, opacityback=0, colbacktitle=quarto-callout-note-color!10!white, left=2mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Demostración}, breakable, toptitle=1mm, titlerule=0mm, rightrule=.15mm, toprule=.15mm, colback=white, opacitybacktitle=0.6]
...
\emph{abscisa} de \(U\) es \(1\) y se denota \(A(1)\). A partir de estos
...
Dados dos números reales tales que \(a<b\), se llama \emph{intervalo
...
\(1\) es un punto frontera del intervalo \([1,\infty)\) ya que no es un
punto interior de \([1,\infty)\) ni de su complementario
\((-\infty,1)\).
...
:::\{\#exm-intervalo-abierto-conjunto-abierto\}. Cualquier intervalo
abierto \((a,b)\) es un conjunto abierto. Por otro lado, un intervalo
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomrule=.15mm, bottomtitle=1mm, leftrule=.75mm, colframe=quarto-callout-warning-color-frame, coltitle=black, opacityback=0, colbacktitle=quarto-callout-warning-color!10!white, left=2mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Advertencia}, breakable, toptitle=1mm, titlerule=0mm, rightrule=.15mm, toprule=.15mm, colback=white, opacitybacktitle=0.6]
...
\((x_n)_{n=1}^\infty\), donde \(x_n=x(n)\) con \(n\in\mathbb{N}\).
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomrule=.15mm, bottomtitle=1mm, leftrule=.75mm, colframe=quarto-callout-caution-color-frame, coltitle=black, opacityback=0, colbacktitle=quarto-callout-caution-color!10!white, left=2mm, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Precaución}, breakable, toptitle=1mm, titlerule=0mm, rightrule=.15mm, toprule=.15mm, colback=white, opacitybacktitle=0.6]
