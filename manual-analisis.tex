...
\end{tabular}
\end{flushleft}
\end{titlepage}\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[frame hidden, borderline west={3pt}{0pt}{shadecolor}, interior hidden, boxrule=0pt, sharp corners, breakable, enhanced]}{\end{tcolorbox}}\fi
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, leftrule=.75mm, colframe=quarto-callout-note-color-frame, toprule=.15mm, rightrule=.15mm, bottomrule=.15mm, coltitle=black, colback=white, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, arc=.35mm, left=2mm, toptitle=1mm, opacityback=0, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Demostración}, breakable, bottomtitle=1mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, leftrule=.75mm, colframe=quarto-callout-warning-color-frame, toprule=.15mm, rightrule=.15mm, bottomrule=.15mm, coltitle=black, colback=white, colbacktitle=quarto-callout-warning-color!10!white, titlerule=0mm, arc=.35mm, left=2mm, toptitle=1mm, opacityback=0, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Advertencia}, breakable, bottomtitle=1mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, leftrule=.75mm, colframe=quarto-callout-important-color-frame, toprule=.15mm, rightrule=.15mm, bottomrule=.15mm, coltitle=black, colback=white, colbacktitle=quarto-callout-important-color!10!white, titlerule=0mm, arc=.35mm, left=2mm, toptitle=1mm, opacityback=0, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Importante}, breakable, bottomtitle=1mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, leftrule=.75mm, colframe=quarto-callout-caution-color-frame, toprule=.15mm, rightrule=.15mm, bottomrule=.15mm, coltitle=black, colback=white, colbacktitle=quarto-callout-caution-color!10!white, titlerule=0mm, arc=.35mm, left=2mm, toptitle=1mm, opacityback=0, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Precaución}, breakable, bottomtitle=1mm]
