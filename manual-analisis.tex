...
\end{tabular}
\end{flushleft}
\end{titlepage}\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[borderline west={3pt}{0pt}{shadecolor}, interior hidden, breakable, enhanced, sharp corners, frame hidden, boxrule=0pt]}{\end{tcolorbox}}\fi
...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, breakable, bottomtitle=1mm, opacityback=0, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white, left=2mm, arc=.35mm, colback=white, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Demostración}, toprule=.15mm, coltitle=black, leftrule=.75mm, toptitle=1mm]
...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, breakable, bottomtitle=1mm, opacityback=0, opacitybacktitle=0.6, colbacktitle=quarto-callout-warning-color!10!white, left=2mm, arc=.35mm, colback=white, colframe=quarto-callout-warning-color-frame, bottomrule=.15mm, titlerule=0mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Advertencia}, toprule=.15mm, coltitle=black, leftrule=.75mm, toptitle=1mm]
...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, breakable, bottomtitle=1mm, opacityback=0, opacitybacktitle=0.6, colbacktitle=quarto-callout-important-color!10!white, left=2mm, arc=.35mm, colback=white, colframe=quarto-callout-important-color-frame, bottomrule=.15mm, titlerule=0mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Importante}, toprule=.15mm, coltitle=black, leftrule=.75mm, toptitle=1mm]
...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, breakable, bottomtitle=1mm, opacityback=0, opacitybacktitle=0.6, colbacktitle=quarto-callout-caution-color!10!white, left=2mm, arc=.35mm, colback=white, colframe=quarto-callout-caution-color-frame, bottomrule=.15mm, titlerule=0mm, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Precaución}, toprule=.15mm, coltitle=black, leftrule=.75mm, toptitle=1mm]
...
Decimos que \(x\) \emph{tiende} a un valor \(a\), y lo escribimos
...
\subsection{Definición de límite}\label{definiciuxf3n-de-luxedmite}}
...
\(f:\mathbb{R}\rightarrow \mathbb{R}\) cuando \(x\rightarrow a\) es
\(l\), y se escribe

\[\lim_{x\rightarrow a} f(x) = l\]

si para cualquier número \(\varepsilon>0\) existe un número \(\delta>0\)
tal que, \(|f(x)-l|<\varepsilon\) \(\forall |x-a|<\delta\).
...
\hypertarget{definiciuxf3n-de-luxedmite-en-el-infinito}{%
\subsection{Definición de límite en el
infinito}\label{definiciuxf3n-de-luxedmite-en-el-infinito}}
...
Se dice que el límite de la función
\(f:\mathbb{R}\rightarrow \mathbb{R}\) cuando \(x\rightarrow +\infty\)
es \(l\), y se escribe

\[\lim_{x\rightarrow +\infty} f(x) =l\]

si para cualquier valor \(\varepsilon>0\) existe un número \(\delta>0\)
tal que, \(|f(x)-l| <\varepsilon\) siempre que \(x>\delta\).

Se dice que el límite de la función \(f\) cuando
\(x\rightarrow -\infty\) es \(l\), y se escribe
...
Dadas dos funciones \(f,g:\mathbb{R}\rightarrow \mathbb{R}\), tales que
existe \(\lim_{x\rightarrow a}f(x)\) y \(\lim_{x\rightarrow a}g(x)\),
...
\subsection{Límites de las funciones
