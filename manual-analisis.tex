...
\end{tabular}
\end{flushleft}
\end{titlepage}\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[sharp corners, frame hidden, enhanced, boxrule=0pt, borderline west={3pt}{0pt}{shadecolor}, breakable, interior hidden]}{\end{tcolorbox}}\fi
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, opacityback=0, toptitle=1mm, colback=white, toprule=.15mm, bottomtitle=1mm, titlerule=0mm, breakable, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, arc=.35mm, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Demostración}, colframe=quarto-callout-note-color-frame, leftrule=.75mm, bottomrule=.15mm, coltitle=black]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, opacityback=0, toptitle=1mm, colback=white, toprule=.15mm, bottomtitle=1mm, titlerule=0mm, breakable, colbacktitle=quarto-callout-warning-color!10!white, opacitybacktitle=0.6, arc=.35mm, rightrule=.15mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Advertencia}, colframe=quarto-callout-warning-color-frame, leftrule=.75mm, bottomrule=.15mm, coltitle=black]
...
\(\overline{(-\infty, 1)}=[1,\infty)\), porque por muy pequeño que
tomemos \(\varepsilon>0\), \(1-\varepsilon < 1\) y, por tanto, el
entorno \((1-\varepsilon, 1+\varepsilon)\) siempre tendrá valores
menores que 1, de manera que
\((1-\varepsilon, 1+\varepsilon)\not \subseteq [1,\infty)\).

\end{example}

:::\{.callout-warning\} El que un punto no sea punto interior de un
conjunto no significa que sea un punto exterior. Por ejemplo, \(1\) no
es un punto interior del intervalo \$(0,1)
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, opacityback=0, toptitle=1mm, colback=white, toprule=.15mm, bottomtitle=1mm, titlerule=0mm, breakable, colbacktitle=quarto-callout-important-color!10!white, opacitybacktitle=0.6, arc=.35mm, rightrule=.15mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Importante}, colframe=quarto-callout-important-color-frame, leftrule=.75mm, bottomrule=.15mm, coltitle=black]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, opacityback=0, toptitle=1mm, colback=white, toprule=.15mm, bottomtitle=1mm, titlerule=0mm, breakable, colbacktitle=quarto-callout-caution-color!10!white, opacitybacktitle=0.6, arc=.35mm, rightrule=.15mm, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Precaución}, colframe=quarto-callout-caution-color-frame, leftrule=.75mm, bottomrule=.15mm, coltitle=black]
