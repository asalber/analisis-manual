...
\end{tabular}
\end{flushleft}
\end{titlepage}\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[boxrule=0pt, borderline west={3pt}{0pt}{shadecolor}, breakable, enhanced, interior hidden, sharp corners, frame hidden]}{\end{tcolorbox}}\fi
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, bottomrule=.15mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white, bottomtitle=1mm, colback=white, rightrule=.15mm, arc=.35mm, toptitle=1mm, breakable, titlerule=0mm, colframe=quarto-callout-note-color-frame, coltitle=black, toprule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Demostración}, leftrule=.75mm, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, bottomrule=.15mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-warning-color!10!white, bottomtitle=1mm, colback=white, rightrule=.15mm, arc=.35mm, toptitle=1mm, breakable, titlerule=0mm, colframe=quarto-callout-warning-color-frame, coltitle=black, toprule=.15mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Advertencia}, leftrule=.75mm, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, bottomrule=.15mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-important-color!10!white, bottomtitle=1mm, colback=white, rightrule=.15mm, arc=.35mm, toptitle=1mm, breakable, titlerule=0mm, colframe=quarto-callout-important-color-frame, coltitle=black, toprule=.15mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Importante}, leftrule=.75mm, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, bottomrule=.15mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-caution-color!10!white, bottomtitle=1mm, colback=white, rightrule=.15mm, arc=.35mm, toptitle=1mm, breakable, titlerule=0mm, colframe=quarto-callout-caution-color-frame, coltitle=black, toprule=.15mm, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Precaución}, leftrule=.75mm, left=2mm]
