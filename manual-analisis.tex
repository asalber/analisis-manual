...
\end{tabular}
\end{flushleft}
\end{titlepage}\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[breakable, boxrule=0pt, sharp corners, borderline west={3pt}{0pt}{shadecolor}, enhanced, interior hidden, frame hidden]}{\end{tcolorbox}}\fi
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, colbacktitle=quarto-callout-note-color!10!white, coltitle=black, bottomtitle=1mm, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, leftrule=.75mm, breakable, left=2mm, bottomrule=.15mm, toptitle=1mm, arc=.35mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Demostración}, titlerule=0mm, opacityback=0, toprule=.15mm, rightrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, colbacktitle=quarto-callout-warning-color!10!white, coltitle=black, bottomtitle=1mm, colframe=quarto-callout-warning-color-frame, opacitybacktitle=0.6, leftrule=.75mm, breakable, left=2mm, bottomrule=.15mm, toptitle=1mm, arc=.35mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Advertencia}, titlerule=0mm, opacityback=0, toprule=.15mm, rightrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, colbacktitle=quarto-callout-important-color!10!white, coltitle=black, bottomtitle=1mm, colframe=quarto-callout-important-color-frame, opacitybacktitle=0.6, leftrule=.75mm, breakable, left=2mm, bottomrule=.15mm, toptitle=1mm, arc=.35mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Importante}, titlerule=0mm, opacityback=0, toprule=.15mm, rightrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, colbacktitle=quarto-callout-caution-color!10!white, coltitle=black, bottomtitle=1mm, colframe=quarto-callout-caution-color-frame, opacitybacktitle=0.6, leftrule=.75mm, breakable, left=2mm, bottomrule=.15mm, toptitle=1mm, arc=.35mm, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Precaución}, titlerule=0mm, opacityback=0, toprule=.15mm, rightrule=.15mm]
...
\item
  ...
  \item
    ...
    \([-\pi/2,\pi/2]\).\footnote{Se pude simplificar porque aunque
      \(x\rightarrow 1\), \(x\neq 1\) y por tanto el denominador no se
      anula.}
  \end{itemize}
\item
...
\(x\rightarrow a\), si se pueden tomar valores de \(x\) tan próximos a
\(a\) como se quiera, pero sin llegar a valer \(a\).
...
\(x\rightarrow a^-\), y si es por exceso (con valores mayores que \(a\))
se dice que \(x\) tiende a \(a\) por la derecha, y se escribe
\(x\rightarrow a^+\).
...
que \(l\) es el \emph{límite} de \(f(x)\) cuando \(x\rightarrow a\), y
se escribe
...
\(f(x)\) cuando \(x\rightarrow a^-\), y se escribe
...
A veces, cuando \(x\rightarrow a\) los valores de \(f(x)\) crecen o
decrecen infinitamente y entonces no existe el límite. En este caso se
dice que la función \emph{diverge} y se escribe
...
veamos que pasa cuando \(x\rightarrow 0\):
...
\(x\rightarrow +\infty\), y se escribe
...
\(f:A\rightarrow \mathbb{R}\) y un punto de acumulación \(a\) de \(A\),
se dice que \(l\in\mathbb{R}\) es el \emph{límite} de \(f\) en \(a\) y
se escribe
...
Dado un conjunto \(A\subseteq \mathbb{R}\), una función
\(f:A\rightarrow \mathbb{R}\) y un punto de acumulación \(a\) de \(A\),
si existe el límite de \(f\) en \(a\), entonces es único.
...
Dado un conjunto \(A\subseteq \mathbb{R}\), una función
\(f:A\rightarrow \mathbb{R}\) y un punto de acumulación \(a\) de \(A\),
se cumple que \(\lim_{x\to a}f(x)=l\) si y solo si para cualquier
sucesión \((x_n)_{n=1}^\infty\) en \(A\setminus\{a\}\) que converge a
\(a\), se tiene que \((f(x_n))_{n=1}^\infty\) converge a \(l\).
...
Dado un conjunto \(A\subseteq \mathbb{R}\), una función
\(f:A\rightarrow \mathbb{R}\) y un punto de acumulación \(a\) de \(A\),
se dice que \(f\) está \emph{acotada} en el entorno de \(a\) si existe
un \(\delta>0\) y un \(c>0\) tal que \(|f(x)|<c\) \(\forall x\in A\) con
\(|x-a|<\delta\).
...
Dado un conjunto \(A\subseteq \mathbb{R}\), una función
\(f:A\rightarrow \mathbb{R}\) y un punto de acumulación \(a\) de \(A\),
si existe el límite de \(f\) en \(a\), entonces \(f\) está acotada en un
entorno de \(a\).
...
\(f,g:A\rightarrow \mathbb{R}\) y un punto de acumulación \(a\) de
\(A\), tales que existe \(\lim_{x\to a}f(x)\) y \(\lim_{x\to a}g(x)\),
...
\item
  ...
  entonces
  \(\lim_{x\rightarrow a}\dfrac{f(x)}{g(x)}=\frac{\displaystyle \lim_{x\rightarrow a}f(x)}{\displaystyle \lim_{x\rightarrow a}g(x)}\).
\end{enumerate}
...
\(f,g,h:A\rightarrow \mathbb{R}\) y un punto de acumulación \(a\) de
\(A\), si \(f(x)\leq g(x)\leq h(x)\) \(\forall x\in A\) y
...
Dado un conjunto \(A\subseteq \mathbb{R}\), una función
\(f:A\rightarrow \mathbb{R}\) y un punto de acumulación \(a\) de \(A\),
si existe el límite de \(f\) en \(a\) entonces
...
Dado un conjunto \(A\subseteq \mathbb{R}\), una función
\(f:A\rightarrow \mathbb{R}\) y un punto de acumulación \(a\) de \(A\),
entonces \(\lim_{x\to a}f(x)=l\) si y solo si para cualquier
\(\varepsilon>0\) existe un \(\delta>0\) tal que
\(|f(x)-f(y)|<\varepsilon\) \(\forall x,y\in A\setminus\{a\}\) con
\(|x-a|<\delta|\) y \(|y-a|<\delta\).
...
Dado un conjunto \(A\subseteq \mathbb{R}\) y una función
\(f:A\rightarrow \mathbb{R}\), y sea \(a\) un punto de acumulación de
los conjuntos \(\{x\in A: x>a\}\) y \(\{x\in A: x<a\}\), entonces
...
\(a\) de \(A\) y dos funciones \(f,g:A\rightarrow \mathbb{R}\) tales que
...
\(f:A\rightarrow \mathbb{R}\), se dice que \(f\) tiende a \(l\) cuando
\(x\) tiende \(\infty\), y se denota \(\lim_{x\to\infty}f(x)=l\), si
para cada \(\varepsilon>0\) existe \(\delta>a\) tal que
...
\(g:B\rightarrow \mathbb{R}\), se dice que \(g\) tiende a \(l\) cuando
\(x\) tiende \(-\infty\), y se denota \(\lim_{x\to-\infty}g(x)=l\), si
para cada \(\varepsilon>0\) existe \(\delta<b\) tal que
\(|f(x)-l|<\varepsilon\) \(\forall x<\delta\).
...
Dado un conjunto \(A\subseteq \mathbb{R}\) tal que
\((a,\infty)\subset A\) para algún \(a\in\mathbb{R}\), y una función
\(f:A\rightarrow \mathbb{R}\), entonces \(\lim_{x\to\infty}f(x)=l\) si y
solo si para cualquier sucesión \((x_n)_{n=1}^\infty\) en \((a,\infty)\)
que diverja a \(\infty\), \(\lim_{n\to\infty}f(x_n)=l\).
...
Dado un conjunto \(A\subseteq \mathbb{R}\) tal que
\((a,\infty)\subset A\) para algún \(a\in\mathbb{R}\), y una función
\(f:A\rightarrow \mathbb{R}\), se dice que \(f\) tiende a \(\infty\)
cuando \(x\) tiende \(\infty\), y se denota
\(\lim_{x\to\infty}f(x)=\infty\), si para cada \(\varepsilon>0\) existe
\(\delta>a\) tal que \(f(x)>\varepsilon\) \(\forall x>\delta\).

Y dado un conjunto \(B\subseteq \mathbb{R}\) tal que
\((-\infty,b)\subset B\) para algún \(b\in\mathbb{R}\), y una función
\(g:B\rightarrow \mathbb{R}\), se dice que \(g\) tiende a \(\infty\)
cuando \(x\) tiende \(-\infty\), y se denota
\(\lim_{x\to-\infty}g(x)=\infty\), si para cada \(\varepsilon>0\) existe
\(\delta<b\) tal que \(f(x)<\varepsilon\) \(\forall x<\delta\).
...
\(f,g:A\rightarrow \mathbb{R}\), tales que \(g(x)>0\) \(\forall x\in A\)
y \(\lim_{x\to\infty}\frac{f(x)}{g(x)}=l\), entonces:
...
en cualquier punto \(a\in \mathbb{R}\) y
...
y en ese caso, \(\lim_{x\rightarrow a}f(x)=f(a)\).
...
\begin{itemize}
\item
  \textbf{Tipo cociente}. Si \(\lim_{x\rightarrow a} f(x)=0\) y
  \(\lim_{x\rightarrow a} g(x)=0\), entonces \(\dfrac{f(x)}{g(x)}\)
  presenta una indeterminación del tipo \(\dfrac{0}{0}\) cuando
  \(x\rightarrow a\).

  Si \(\lim_{x\rightarrow a} f(x)=\pm\infty\) y
  \(\lim_{x\rightarrow a} g(x)=\pm\infty\), entonces
  \(\dfrac{f(x)}{g(x)}\) presenta una indeterminación del tipo
  \(\pm\dfrac{\infty}{\infty}\) cuando \(x\rightarrow a\).
\item
  \textbf{Tipo producto}. Si \(\lim_{x\rightarrow a} f(x)=0\) y
  \(\lim_{x\rightarrow a} g(x)=\pm\infty\), entonces \(f(x)\cdot g(x)\)
  presenta una indeterminación del tipo \(0\cdot \pm\infty\) cuando
  \(x\rightarrow a\).
\item
  \textbf{Tipo potencia}. Si \(\lim_{x\rightarrow a} f(x)=1\) y
  \(\lim_{x\rightarrow a} g(x)=\infty\), entonces \(f(x)^{g(x)}\)
  presenta una indeterminación del tipo \(1^\infty\) cuando
  \(x\rightarrow a\).

  Si \(\lim_{x\rightarrow a} f(x)=0\) y
  \(\lim_{x\rightarrow a} g(x)=0\), entonces \(f(x)^{g(x)}\) presenta
  una indeterminación del tipo \(0^0\) cuando \(x\rightarrow a\).

  Si \(\lim_{x\rightarrow a} f(x)=\infty\) y
  \(\lim_{x\rightarrow a} g(x)=0\), entonces \(f(x)^{g(x)}\) presenta
  una indeterminación del tipo \(\infty^0\) cuando \(x\rightarrow a\).
\item
  \textbf{Tipo diferencia}. Si \(\lim_{x\rightarrow a} f(x)=\infty\) y
  \(\lim_{x\rightarrow a} g(x)=\infty\), entonces \(f(x)-g(x)\) presenta
  una indeterminación del tipo \(\infty-\infty\) cuando
  \(x\rightarrow a\).
\end{itemize}
...
indeterminación de tipo cociente cuando \(x\rightarrow a\), y \(a\) es
una raíz de \(p(x)\) y \(q(x)\), se puede resolver la indeterminación
...
La función \(f(x)=\dfrac{x^3-3x+2}{x^4-4x+3}\rightarrow \dfrac{0}{0}\)
...
Si \(f(x)=\dfrac{p(x)}{q(x)}\) es una función racional que presenta una
indeterminación de tipo cociente cuando \(x\rightarrow \pm\infty\),
entonces se puede resolver dividendo \(p(x)\) y \(q(x)\) por el término
de mayor grado de ambos polinomios.
...
La función
\(f(x)=\dfrac{x^3-3x+2}{x^4-4x+3}\rightarrow \dfrac{\infty}{\infty}\)
...
\item
  Si \(n=m\) entonces
  \(\lim_{x\rightarrow \pm \infty}f(x)=\dfrac{a_n}{b_m}\).
\end{itemize}
...
Si \(f(x)\rightarrow 0\) y \(g(x)\rightarrow 0\) cuando
\(x\rightarrow a\), entonces se dice que \(f\) y \(g\) son
\emph{infinitésimos equivalentes} cuando \(x\rightarrow a\) si se cumple
...
Si \(f(x)\approx g(x)\) cuando \(x\rightarrow a\) entonces \(f(x)\) y
\(g(x)\) son magnitudes equivalentes cuando \(x\rightarrow a\).
...
A veces se puede resolver una indeterminación cuando \(x\rightarrow a\)
...
La función
\(f(x)=\dfrac{\operatorname{sen} x(1- \cos x)}{x^3}\rightarrow \dfrac{0}{0}\)
cuando \(x\rightarrow 0\).

Como \(\operatorname{sen} x \approx x\) y
\(1-\cos x\approx \dfrac{x^2}{2}\) cuando \(x\rightarrow 0\), para
resolver la indeterminación sustituimos \(\operatorname{sen} x\) por
\(x\) y \(1-\cos x\) por \(\dfrac{x^2}{2}\):
...
Si \(\dfrac{f(x)}{g(x)}\rightarrow \dfrac{0}{0}\) o
\(\dfrac{\infty}{\infty}\) cuando \(x\rightarrow a\), entonces si existe
el límite de \(\dfrac{f'(x)}{g'(x)}\) cuando \(x\rightarrow a\) se
cumple
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, colbacktitle=quarto-callout-warning-color!10!white, coltitle=black, bottomtitle=1mm, colframe=quarto-callout-warning-color-frame, opacitybacktitle=0.6, leftrule=.75mm, breakable, left=2mm, bottomrule=.15mm, toptitle=1mm, arc=.35mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Advertencia}, titlerule=0mm, opacityback=0, toprule=.15mm, rightrule=.15mm]
Para que exista \(\lim_{x\rightarrow a}\dfrac{f'(x)}{g'(x)}\) es
necesario que que \(f\) y \(g\) sean derivables en un entorno de \(a\).
\end{tcolorbox}

\leavevmode\vadjust pre{\hypertarget{exm-regla-lhopital}{}}%
\begin{example}[]\label{exm-regla-lhopital}

Sea \(f(x)=\dfrac{\log(x^2-1)}{x+2}\rightarrow \dfrac{\infty}{\infty}\)
cuando \(x\rightarrow \infty\).
...
Si \(f(x)\rightarrow 0\) y \(g(x)\rightarrow \pm\infty\) cuando
\(x\rightarrow a\), entonces la indeterminación
\(f(x)\cdot g(x)\rightarrow 0\cdot \pm\infty\) puede convertirse en una
de tipo cociente mediante la transformación:
...
Sea \(f(x)=x^2e^{1/x^2}\rightarrow 0\cdot\infty\) cuando
\(x\rightarrow 0\).
...
\(x\rightarrow a\), entonces la indeterminación puede convertirse en una
de tipo producto mediante la transformación:
...
Sea \(f(x)=\left(1+\dfrac{1}{x}\right)^{x} \rightarrow 1^\infty\) cuando
\(x\rightarrow 0\).
...
Si \(f(x)\rightarrow \infty\) y \(g(x)\rightarrow \infty\) cuando
\(x\rightarrow a\), entonces la indeterminación \(f(x)-g(x)\) puede
convertirse en una de tipo cociente mediante la transformación:
...
Sea
\(f(x)=\dfrac{1}{\operatorname{sen} x}-\dfrac{1}{x} \rightarrow \infty-\infty\)
cuando \(x\rightarrow 0\).
...
\leavevmode\vadjust pre{\hypertarget{def-funcion-continua}{}}%
\begin{definition}[Función continua en un
punto]\label{def-funcion-continua}
...
Se dice que una función \(f\) es \emph{continua} en un intervalo si lo
es en cada uno de los puntos del intervalo.
...
en el punto \(a\) si existe el límite de \(f(x)\) cuando
\(x\rightarrow a\) pero
...
laterales de \(f(x)\) cuando \(x\rightarrow a\) pero
