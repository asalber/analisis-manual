...
Ya se vió, por el @thm-weierstrass, que una función continua en un intervalo cerrado $[a,b]$ alcanza el máximo y el mínimo absolutos en ese intervalo. Así pues, para encontrar los extremos absolutos de una función $f$ derivable en $[a,b]$, basta con seguir el siguiente procedimiento:
