...
a. Supongamos que existe $b\in\mathbb{R}$ tal que $b+a=a$ $\forall a\in\mathbb{R}$. Entonces 
    ...
    \begin{align}
    b+a = a &\Leftrightarrow b+a+(-a)=a+(-a) \tag{\small{axioma 5}}\\
    & \Leftrightarrow b+0 = 0 \tag{\small{axioma 4}}\\
    &\Leftrightarrow b=0
    \end{align}
...
a. Supongamos que existe $b\in\mathbb{R}$ tal que $b\cdot a=a$ $\forall a\in\mathbb{R}$. Entonces 
    ...
    \begin{align}
    b\cdot a = a &\Leftrightarrow b\cdot a\cdot a^{-1}=a\cdot a^{-1} \tag{\small{axioma 10}}\\
    & \Leftrightarrow b\cdot 1 = 1 \tag{\small{axioma 9}}\\
    &\Leftrightarrow b=1
    \end{align}
...
a. Sea $a,b\in \mathbb{R}$ tales que $a+b=0$. Entonces 
    ...
    \begin{align}
    a+b=0 &\Leftrightarrow (-a)+a+b = (-a)+0 \tag{\small{axioma 4}}\\
    &\Leftrightarrow (-a)+a+b = -a \tag{\small{axioma 5}} \\
    & \Leftrightarrow 0+b=-a \tag{\small{axioma 4}}\\ 
    & \Leftrightarrow b = -a
    \end{align}
...
a. Sea $a,b\in \mathbb{R}$ tales que $a\cdot b=1$. Entonces 
    ...
    \begin{align}
    a\cdot b=1 &\Leftrightarrow a^{-1}\cdot a\cdot b = a^{-1}\cdot 1 \tag{\small{axioma 9}}\\
    &\Leftrightarrow a^{-1}\cdot a\cdot b = a^{-1}  \tag{\small{axioma 10}} \\
    & \Leftrightarrow 1\cdot b=a^{-1} \tag{\small{axioma 9}}\\ 
...
a. Para cualquier $a\in\mathbb{R}$, se tiene 
    ...
    \begin{align}
    a+(-a)=0 & \Leftrightarrow \tag{\small{axioma 5}}\\ 
    &\Leftrightarrow (-a)+a=0 \tag{\small{axioma 3}} \\ 
...
a. Para cualesquiera $a,b\in\mathbb{R}$,se tiene
    ...
    &= (-1)(-1)\cdot a\cdot  b\tag{\small{axioma 7}}\\ 
...
a. Para cualquier $a\in\mathbb{R}$, se tiene 
    ...
    \begin{align}
    a\cdot a^{-1}=1 &\Leftrightarrow \tag{\small{axioma 10}}\\ 
    &\Leftrightarrow a^{-1}\cdot a=1 \tag{\small{axioma 8}} \\ 
...
a. Sean $a,b,c\in\mathbb{R}$ tales que $a\cdot b=a\cdot c$ y $a\neq 0$. Entonces se tiene
    ...
    \begin{align}
    a\cdot b = a\cdot c &\Leftrightarrow a^{-1}\cdot (a\cdot b) = a^{-1}\cdot (a \cdot c)\tag{\small{axioma 7}}\\ 
    &\Leftrightarrow (a^{-1}\cdot a)\cdot b = (a^{-1}\cdot a) \cdot c\tag{\small{axioma 10}}\\
    &\Leftrightarrow 1\cdot b = 1\cdot c\tag{\small{axioma 9}}\\
    &\Leftrightarrow b = c
    \end{align}
...
a. Sean $a,b\in\mathbb{R}$ tales que $a\cdot b=0$. Supongamos que $a\neq 0$, entonces se tiene
    ...
    \begin{align}
    a\cdot b = 0 &\Leftrightarrow a^{-1}\cdot (a\cdot b) = a^{-1}\cdot 0\tag{\small{prop. e}}\\ 
    &\Leftrightarrow a^{-1}\cdot (a\cdot b) = 0\tag{\small{axioma 7}}\\ 
    &\Leftrightarrow (a^{-1}\cdot a)\cdot b = 0\tag{\small{axioma 10}}\\
    &\Leftrightarrow 1\cdot b = 0\tag{\small{axioma 9}}\\
    &\Leftrightarrow b = 0
    \end{align}
...
a. Sean $a,b\in \mathbb{R}$, tales que $a\neq 0$ y $b\neq 0$. Entonces, por la propiedad l se tiene $a\cdot b\neq 0$, y se tiene
    ...
    \begin{align}
    (a\cdot b)\cdot (a\cdot b)^{-1} = 1 &\Leftrightarrow a^{-1} \cdot (a\cdot b)\cdot (a\cdot b)^{-1} = a^{-1}\cdot 1 \tag{\small{axioma 9}}\\ 
    &\Leftrightarrow a^{-1} \cdot (a\cdot b)\cdot (a\cdot b)^{-1} = a^{-1} \tag{\small{axioma 7}}\\ 
    &\Leftrightarrow (a^{-1} \cdot a)\cdot b\cdot (a\cdot b)^{-1} = 1 \tag{\small{axioma 10}}\\
    &\Leftrightarrow 1 \cdot b\cdot (a\cdot b)^{-1} = a^{-1} \tag{\small{axioma 9}}\\ 
    &\Leftrightarrow b\cdot (a\cdot b)^{-1} = a^{-1}\Leftrightarrow \\
    &\Leftrightarrow b^{-1}\cdot  b\cdot (a\cdot b)^{-1} = b^{-1}a^{-1}\tag{\small{axioma 8}}\\
    &\Leftrightarrow b^{-1}\cdot  b\cdot (a\cdot b)^{-1} = a^{-1}b^{-1}\tag{\small{axioma 7}}\\ 
    &\Leftrightarrow (b^{-1}\cdot  b)\cdot (a\cdot b)^{-1} = a^{-1}b^{-1}\tag{\small{axioma 10}}\\
    &\Leftrightarrow 1\cdot (a\cdot b)^{-1} = a^{-1}b^{-1}\tag{\small{axioma 9}}\\
...
b. El elemento neutro de la suma es menor que el elemento neutro del producto: $0<1$.

c. Cualquier número natural es positivo: $\forall n\in\mathbb{N}$, $0<n$.

d. La suma preserva el orden: $\forall a,b,c\in\mathbb{R}$, si $a< b$, entonces $a+c< b+c$.

e. $\forall a,b,c,d\in\mathbb{R}$, si $a<b$ y $c<d$, entonces $a+c<b+d$.

f. El producto por un número real positivo preserva el orden: $\forall a,b,c\in\mathbb{R}$, si $a<b$ y $c>0$, entonces $a\cdot c< b\cdot c$.

g. El producto por un número real negativo invierte el orden: $\forall a,b,c\in\mathbb{R}$, si $a<b$ y $c<0$, entonces $a\cdot c>b\cdot c$.

h. El inverso de un número real positivo es positivo y el de un número real negativo es negativo: $\forall a\in\mathbb{R}$, si $a>0$, entonces $a^{-1}>0$, y si $a<0$, entonces $a^{-1}<0$.

i. El producto de dos números reales es positivo si y solo si los dos números son positivos, o bien los dos números son negativos: $\forall a,b\in\mathbb{R}$, $a\cdot b>0$ si y solo si $a>0$ y $b>0$, o $a<0$ y $b<0$.

j. El producto de dos números reales es negativo si y solo si uno de los números es positivo y el otro negativo: $\forall a,b\in\mathbb{R}$, $a\cdot b<0$ si y solo si $a>0$ y $b<0$, o $a<0$ y $b>0$.

k. $\forall a,b\in\mathbb{R}$, si $a<b$, entonces $a<\dfrac{a+b}{2}< b$.

l. Cualquier número no negativo que es menor que cualquier número positivo es $0$: $\forall a,b\in\mathbb{R}$, si $0\leq a<b$ y $b>0$, entonces $a=0$.
:::
...
b. Por el axioma 9 se tiene que $1=1\cdot 1=1^2$, y por la propiedad anterior se tiene que $1^2>0$, con lo que $1>0$.

c. Haremos la prueba por inducción. Para $n=1$ ya hemos visto en resultado anterior que $1>0$. Supongamos ahora que para cualquier $n\in\mathbb{N}$ se cumple que $n-1>0$. Entonces, como $1>0$, por el axioma 12 se tiene que $n-1+1>0$, de lo que se deduce, por los axiomas 5 y 4 que $n>0$.

d. Sean $a,b\in\mathbb{R}$ tales que $a<b$. Entonces $b-a> 0$. Si tomamos ahora cualquier $c\in\mathbb{R}$ se cumple que
...
e. Sean $a,b,c,d\in\mathbb{R}$ tales que $a < b$ y $c < d$. Entonces se tiene
...
f. Sean $a,b\in\mathbb{R}$ tales que $a<b$. Entonces $b-a > 0$. Si tomamos ahora cualquier $c\in\mathbb{R}$  con $c>0$, se cumple que
...
g. Sean $a,b\in\mathbb{R}$ tales que $a<b$. Entonces $b-a > 0$. Si tomamos ahora cualquier $c\in\mathbb{R}$  con $c<0$, entonces $-c>0$ y se cumple que
...
i. Sean $a,b\in\mathbb{R}$ tales que $a\cdot b>0$. Entonces, por la propiedad algebraica e se tiene $a\neq 0$ y $b\neq 0$, y por la propiedad de tricotomía se tiene que $a>0$ o $a<0$. 
...
j. Se demuestra de forma análoga a la propiedad anterior.

k. Sean $a,b\in\mathbb{R}$ tales que $a<b$. Entonces se tiene
...
l. Sea $a\in\mathbb{R}$ tal que $0\leq a <b$ $\forall b\in\mathbb{R}$ con $b>0$. Como $a\geq 0$ se tiene que $a>0$ o $a=0$. Si $a>0$, por la propiedad anterior se tiene $0<\frac{a}{2}<a$. Si ahora tomamos $b=\frac{a}{2}>0$ se tiene que $a<\frac{a}{2}$, lo cual es absurdo, y, por tanto, debe ser $a=0$.
:::
:::
...
b. $\forall a,b\in\mathbb{R}$, $|a-b| = |b-a|$.

c. El valor absoluto del producto de dos números reales es igual que el producto de los valores absolutos de los números: $\forall a,b\in\mathbb{R}$, $|a\cdot b|=|a|\cdot |b|$.

d. $\forall a,b\in\mathbb{R}$, si $b>0$ entonces $|a|<b$ si y solo si $-b<a<b$.

e. $\forall a\in\mathbb{R}$, $|-a|\leq a\leq |a|$.

f. Desigualdad triangular: $\forall a,b\in\mathbb{R}$, $|a+b|\leq |a|+|b|$.
:::
...
b. Para cualesquiera $a,b\in\mathbb{R}$ se tiene
    \begin{align}
...
c. Para cualesquiera $a,b\in \mathbb{R}$, se pueden dar varios casos:
...
d. Sean $a,b\in\mathbb{R}$ tales que $b>0$. Si $|a|<b$, entonces $a<b$ y $-a<b$, y para esta última desigualdad se tiene
    ...
    Por tanto, se concluye que $-b<a<b$.

    Para probar la otra implicación supongamos que $-b<a<b$, entonces $a<b$ y por otro lado $a>-b$, de donde se tiene
    ...
    Como $b>0$ se puede concluir que $|a|<b$.

e. Sea $a\in\mathbb{R}$. Como $|a|\leq |a|$, si $|a|>0$, por la propiedad anterior, se tiene que $-|a|\leq a\leq |a|$, y si $|a|=0$, entonces $a=0$ y $-|0|\leq 0\leq |0|$.

f. Sean $a,b\in\mathbb{R}$. Por la propiedad anterior se tiene que $-|a|\leq a\leq |a|$ y $-|b|\leq b\leq |b|$ de manera que, por la propiedad de orden e, se cumple 
