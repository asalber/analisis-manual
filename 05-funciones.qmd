...
![Dominio de la función $f(x)=\frac{1}{\sqrt{x^2-1}}$.](./img/funciones/ejemplo-dominio)
...
![Imagen de la función $f(x)=x^2-2$.](./img/funciones/ejemplo-imagen)
...
![Gráfica de una función constante.](./img/funciones/funcion-constante)
...
![Gráfica de la función identidad.](./img/funciones/funcion-identidad)
...
::: {layout-ncol=2}
![Función creciente.](./img/funciones/funcion-creciente)

![Función decreciente.](./img/funciones/funcion-decreciente)
:::
...
::: {layout-ncol=2}
![Máximo relativo.](./img/funciones/maximo)

![Mínimo relativo.](./img/funciones/minimo)
:::
...
::: {layout-ncol=2}
![Función cóncava hacia arriba.](./img/funciones/funcion-concava-arriba)

![Función cóncava hacia abajo.](./img/funciones/funcion-concava-abajo)
:::
...
![Gráficas de funciones polinómicas.](./img/funciones/funcion-polinomica)
:::
...
![Gráficas de funciones racionales.](./img/funciones/funcion-racional)
:::
...
![Gráficas de funciones potenciales.](./img/funciones/funcion-potencial)
:::
...
![Gráficas de funciones exponenciales.](./img/funciones/funcion-exponencial)
:::
...
![Gráficas de funciones logaritmicas.](./img/funciones/funcion-logaritmica)
:::
...
:::{#exm-funcion-seno}
![Gráfica de la función seno.](./img/funciones/funcion-seno){width=500}
:::
...
![Gráfica de la función coseno.](./img/funciones/funcion-coseno){width=500}
:::
...
![Gráfica de la función tangente.](./img/funciones/funcion-tangente){width=500}
:::
...
![Gráfica de la función arcoseno.](./img/funciones/funcion-arcoseno){width=200}
:::
...
![Gráfica de la función arcocoseno.](./img/funciones/funcion-arcocoseno){width=200}
:::
...
![Gráfica de la función arcotangente.](./img/funciones/funcion-arcotangente)
:::
