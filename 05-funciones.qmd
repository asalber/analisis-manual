...
![Gráfica de una función.](./img/funciones/grafica-funcion){width=400}
...
![Dominio de la función $f(x)=\frac{1}{\sqrt{x^2-1}}$.](./img/funciones/ejemplo-dominio){width=400}
...
![Imagen de la función $f(x)=x^2-2$.](./img/funciones/ejemplo-imagen){width=400}
...
![Gráfica de una función constante.](./img/funciones/funcion-constante){width=400}
...
![Gráfica de la función identidad.](./img/funciones/funcion-identidad){width=400}
...
![Gráficas de funciones polinómicas.](./img/funciones/funcion-polinomica){width=400}
:::
...
![Gráficas de funciones racionales.](./img/funciones/funcion-racional){width=400}
:::
...
![Gráficas de funciones potenciales.](./img/funciones/funcion-potencial){width=400}
:::
...
![Gráficas de funciones exponenciales.](./img/funciones/funcion-exponencial){width=400}
:::
...
![Gráficas de funciones logaritmicas.](./img/funciones/funcion-logaritmica){width=400}
:::
...
![Gráfica de la función arcotangente.](./img/funciones/funcion-arcotangente){width=400}
:::
