...
\end{tabular}
\end{flushleft}
\end{titlepage}\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[breakable, sharp corners, enhanced, interior hidden, borderline west={3pt}{0pt}{shadecolor}, boxrule=0pt, frame hidden]}{\end{tcolorbox}}\fi
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, coltitle=black, opacityback=0, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, breakable, bottomtitle=1mm, toprule=.15mm, arc=.35mm, toptitle=1mm, left=2mm, titlerule=0mm, rightrule=.15mm, colback=white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Demostración}]
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, colbacktitle=quarto-callout-warning-color!10!white, bottomrule=.15mm, coltitle=black, opacityback=0, colframe=quarto-callout-warning-color-frame, opacitybacktitle=0.6, breakable, bottomtitle=1mm, toprule=.15mm, arc=.35mm, toptitle=1mm, left=2mm, titlerule=0mm, rightrule=.15mm, colback=white, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Advertencia}]
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, colbacktitle=quarto-callout-important-color!10!white, bottomrule=.15mm, coltitle=black, opacityback=0, colframe=quarto-callout-important-color-frame, opacitybacktitle=0.6, breakable, bottomtitle=1mm, toprule=.15mm, arc=.35mm, toptitle=1mm, left=2mm, titlerule=0mm, rightrule=.15mm, colback=white, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Importante}]
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, colbacktitle=quarto-callout-caution-color!10!white, bottomrule=.15mm, coltitle=black, opacityback=0, colframe=quarto-callout-caution-color-frame, opacitybacktitle=0.6, breakable, bottomtitle=1mm, toprule=.15mm, arc=.35mm, toptitle=1mm, left=2mm, titlerule=0mm, rightrule=.15mm, colback=white, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Precaución}]
...
\item
  ...
  :::\{.callout-caution\} La representación algebraica paramétrica puede
  dar lugar a relaciones que no son funciones. Por ejemplo
  \[\begin{cases}
    y=t\\
    x=t^2
    \end{cases}
...
\leavevmode\vadjust pre{\hypertarget{def-imagen-funcion}{}}%
\begin{definition}[Imagen de una función]\label{def-imagen-funcion}
...
{\centering \includegraphics{././img/funciones/ejemplo-imagen.png}
...
Se dice que una función \(f\) tiene un \emph{máximo relativo} en
\(x_0\), si existe un \(\delta>0\) tal que para todo
\(x\in (x_0-\delta,x_0+\delta)\) se cumple \(f(x_0)\geq f(x)\).

Se dice que una función \(f\) tiene un \emph{mínimo relativo} en
\(x_0\), si existe un \(\delta>0\) tal que para todo
\(x\in (x_0-\delta,x_0+\delta)\) se cumple \(f(x_0)\leq f(x)\).
...
\item
  ...
  \item
    ...
    \([-\pi/2,\pi/2]\).\footnote{Para que exista la inversa de la
      función seno, es necesario restringir su dominio a
