...
\Huge
{\textbf{Manual de Análisis Matemático Real}}

\vspace{0.5cm}
\LARGE
{\textbf{para Ciencias e Ingenierías}}

\vspace{1.5cm}

\includegraphics[width=0.4\textwidth]{img/logos/pi.png}
\end{center}
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Demostración}, bottomrule=.15mm, breakable, opacityback=0, opacitybacktitle=0.6, titlerule=0mm, coltitle=black, colback=white, bottomtitle=1mm, toptitle=1mm, rightrule=.15mm, leftrule=.75mm, toprule=.15mm, colframe=quarto-callout-note-color-frame, left=2mm]
...
:::\{\#exm-supremo-infimo-maximo-minimo\}. Si se toma el conjunto de los
números naturales con la relación de orden total \((\mathbb{N},\leq)\),
para el conjunto \(B=\{1, 2, 3\}\subseteq \mathbb{N}\) se tiene que
cualquier \(x\in\mathbb{N}\) tal que \(3\leq x\) es una cota superior de
\(B\), por tanto \(3\) es el supremo de \(B\), y además es un máximo
puesto que \(3\in B\).
...
:::\{\#exm-conjunto-finito-infinito\}. El conjunto \(A=\{a, b, c\}\) es
finito ya que puede definirse una aplicación biyectiva
\(f:A\rightarrow \{1, 2, 3\}\) con los pares \(\{(1,a),(2,b), (3,c)\}\),
y por tanto, \(|A| = 3\).
...
\(s<m+1\), y como \(m\in\mathbb{N}\) también \(n+1\in\mathbb{N}\), lo
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-warning-color!10!white, arc=.35mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Advertencia}, bottomrule=.15mm, breakable, opacityback=0, opacitybacktitle=0.6, titlerule=0mm, coltitle=black, colback=white, bottomtitle=1mm, toptitle=1mm, rightrule=.15mm, leftrule=.75mm, toprule=.15mm, colframe=quarto-callout-warning-color-frame, left=2mm]
...
Sin embargo, \(1\) no es un punto interior del intervalo \([1,\infty)\),
porque por muy pequeño que tomemos \(\varepsilon>0\),
\(1-\varepsilon < 1\) y, por tanto, el entorno
...
Sin embargo, el punto \(1\) no es un punto exterior del intervalo
\((-\infty, 1)\), ya que, como se ha visto en el ejemplo anterior, no es
un punto interior del intervalo \(\overline{(-\infty, 1)}=[1,\infty)\).
...
conjunto si no es un punto interior del conjunto ni de su
complementario.
...
Tomemos cualquier punto in \((a,b)\), entonces se puede tomar
...
Cualquier intervalo abierto \((a,b)\) es un conjunto abierto. Por otro
lado, un intervalo cerrado \([a,b]\) no es un conjunto abierto pues
cualquier entorno de \(a\) o \(b\) no está contenido en \([a,b]\).

\end{example}

\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-important-color!10!white, arc=.35mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Importante}, bottomrule=.15mm, breakable, opacityback=0, opacitybacktitle=0.6, titlerule=0mm, coltitle=black, colback=white, bottomtitle=1mm, toptitle=1mm, rightrule=.15mm, leftrule=.75mm, toprule=.15mm, colframe=quarto-callout-important-color-frame, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-warning-color!10!white, arc=.35mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Advertencia}, bottomrule=.15mm, breakable, opacityback=0, opacitybacktitle=0.6, titlerule=0mm, coltitle=black, colback=white, bottomtitle=1mm, toptitle=1mm, rightrule=.15mm, leftrule=.75mm, toprule=.15mm, colframe=quarto-callout-warning-color-frame, left=2mm]
Un subconjunto puede ser abierto y cerrado a la vez, como \(\emptyset\)
y \(\mathbb{R}\), y también puede no ser abierto ni cerrado, como por
ejemplo \((a,b]\). Por tanto, no abierto no implica cerrado y no cerrado
no implica abierto.
\end{tcolorbox}
...
Sea \(A\subset \mathbb{R}\) un subconjunto finito y acotado. Como \(A\)
está acotado, existe un intervalo cerrado tal que
...
Un subconjunto real \(A\subset \mathbb{R}\) es cerrado si y sólo si
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-caution-color!10!white, arc=.35mm, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Precaución}, bottomrule=.15mm, breakable, opacityback=0, opacitybacktitle=0.6, titlerule=0mm, coltitle=black, colback=white, bottomtitle=1mm, toptitle=1mm, rightrule=.15mm, leftrule=.75mm, toprule=.15mm, colframe=quarto-callout-caution-color-frame, left=2mm]
...
manera que aplicando el teorema anterior de compresión se tiene que
\(\lim_{n\to\infty} \frac{\operatorname{sen}}{n}=0\).
