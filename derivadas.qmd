...
:::{.callout-note}
La demostración es mucho sencilla usando la notación diferencial de Leibniz para la derivada. Si $g=f(z)$ y $z=f(x)$, entonces 
...
## Crecimiento y extremos relativos de una función
