...
Dada una ecuación $F(x,y)=0$, que define implícitamente $y$ como función de $x$, si $y$ es derivable en un punto $(a,y_0)$, se puede calcular la derivada mediante el siguiente procedimiento:
...
Aún cuando la ecuación $F(x,y)=0$ no defina implícitamente a $y$ como función de $x$, es posible utiliza el procedimiento anterior para estudiar la tasa de variación instantánea de $y$ con respecto a $x$ en un punto $(a,y_0)$ que cumpla la ecuación.
