...
## Demostración
:::{.proof}
Sea $(A_n)_{n=1}^\infty$ la sucesión de las sumas parciales de $\sum a_n$. Si la serie $\sum a_n$ es convergente, entonces existe $\lim_{n\to\infty}A_n=l$, y por las propiedades de las colas de sucesiones, también se cumple que $\lim_{n\to\infty}A_{n-1}=l$. 
