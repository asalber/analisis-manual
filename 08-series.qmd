...
:::{#def-serie}
## Serie
Dada una sucesión de números reales $(a_n)_{n=1}^\infty$, se llama _serie_ de término general $a_n$ a la sucesión $(A_n)_{n=1}^\infty$, cuyos términos se obtienen sumando consecutivamente los términos $n$ primeros términos de $(a_n)_{n=1}^\infty$, es decir,
...
:::{#exm-series-geometricas}
## Series geométricas
Dado un número $x$, la sucesión $(1+x+x^{2}+\cdots+x^{n})_{n=1}^\infty$ se llama _serie geométrica_ de razón $x$ y se representa $\sum x^n$.

Veamos que la serie geométrica $\sum \left(\frac{1}{2}\right)^n$ converge. 
...
var params = {
    ...
    window.addEventListener("load", function() { 
        ggbApplet.inject('ggb-series-01');
    });
</script>
:::
:::
...
:::{#thm-condicion-convergencia-series}
## Condición de convergencia
Si la serie $\sum a_n$ converge, entonces $\lim_{n\to\infty} a_n =0$.
:::
...
:::{.callout-warning}
El teorema anterior establece una condición necesaria, pero no suficiente, para la convergencia de una serie. Por ejemplo, como se ha visto antes, la serie armónica $\sum \frac{1}{n}$ no converge pero $\lim_{n\to\infty}\frac{1}{n}=0$.
Por tanto, el hecho que de que $\lim_{n\to\infty} a_n =0$ no garantiza que la serie $\sum a_n$ converja, pero si $(a_n)_{n=1}^\infty$ no converge, o $\lim_{n\to\infty} a_n \neq 0$, entonces se puede concluir que la serie $\sum a_n$ diverge.
:::

:::{#exm-series-divergentes}
...
:::{#exm-serie-p}
La serie $\sum \frac{1}{n^p}$, con $p\in \mathbb{R}$ se conoce como la serie $p$. Usando el teorema anterior, es fácil probar que la serie diverge para $p\leq 0$, ya que $\lim_{n\to\infty} \frac{1}{n^p}=\infty$ si $p<0$ y $\lim_{n\to\infty} \frac{1}{n^p}=1$ si $p=0$.
:::

:::{#exm-series-telescópicas}
Dada una sucesión $(a_n)_{n=1}^\infty$, las series de la forma $\sum (a_n-a_{n+1})$ se conocen como _series telescópicas_. Es fácil ver que la suma parcial de los $n$ primeros términos es
...
de manera que si existe $\lim_{n\to\infty} a_n=l$, la serie telescópica converge y $\sum_{n=1}^\infty (a_n-a_{n+1}) = a_1-l$.
:::
...
## Demostración
:::{.proof}
La demostración es una consecuencia inmediata del teorema anterior, ya que si $\sum a_n$ converge, entonces $\lim_{n\to\infty} a_n = 0$ y, por tanto, $\lim_{n\to\infty} a_n^{-1} = \frac{1}{\lim_{n\to\infty} a_n} = \infty$, por lo que la serie $\sum a_n^{-1}$ diverge.
:::
:::
...
Dada una serie alternada $\sum (-1)^{n-1} a_n$, con $a_n>0$, si cumple 

a. $a_{n+1}\leq a_n$ $\forall n\in\mathbb{N}$,
...
## Demostración
:::{.proof}
Supongamos $a_{n+1}\leq a_n$ $\forall n\in\mathbb{N}$ y $\lim_{n\to\infty} a_n = 0$. Entonces, si construimos la sucesión de las sumas parciales de orden par, se tiene
