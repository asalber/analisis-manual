...
Ya se ha visto que la serie armónica $\sum \frac{1}{n}$ diverge, ya que $p=1$, mientras que la serie $\sum \frac{1}{n^2}$ converge al ser $p=2>1$. De hecho, la suma exacta de esta última serie es el famoso [problema de Basilea](https://es.wikipedia.org/wiki/Problema_de_Basilea) que consiguió resolver Euler, demostrando que que $\sum_{n=1}^\infty \frac{1}{n^2} = \frac{\pi^2}{6}$ (la demostración se escapa de los conocimientos de este curso y puede verse en el enlace anterior).
:::
...
:::{#thm-radio-convergencia-cociente}
...
:::{#exm-radio-convergencia-cociente}
...
Por tanto, la serie converge para $|x|<1$. En $x=1$ la serie que resulta es la serie armónica, que es divergente, y en $x=-1$ la serie que resulta es la serie armónica altenada que converge.
