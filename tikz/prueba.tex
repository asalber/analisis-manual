...
\begin{tikzpicture}[scale=1]
    \tkzInit[xmin=0, xmax=8, ymin=-1, ymax=6, ystep=1]
    \tkzDrawX \tkzDrawY
    \tkzFct[line width=1pt, color = myblue, domain = 1:7]{2*sin(\x-1)+3}
    \tkzDrawRiemannSumInf[fill=myblue!40, opacity=.5, interval=1:7, number=12]
    \end{tikzpicture}
\end{document}
