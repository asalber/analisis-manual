...
:::{#exm-punto-frontera} 
$1$ es un punto frontera del intervalo $[1,\infty)$ ya que no es un punto interior de $[1,\infty)$ ni de su complementario $(-\infty,1)$.
:::
...
Cualquier intervalo abierto $(a,b)$ es un conjunto abierto. Por otro lado, un intervalo cerrado $[a,b]$ no es un conjunto abierto pues cualquier entorno de $a$ o $b$ no está contenido en $[a,b]$.
:::
